...
class Converter:
    ...
    def __init__(self):
        ...
        # six item list
        self.all_calculations = ['0 F is -18 C', '0 C is 32 F', '30 C is 86 F',
                                 '40 F is 4 C', '100 C is 212 F', '40 F is 4 C', '100 C is 212 F']
...
class HistoryExport:
    ...
    def __init__(self, partner, calc_list):
        ...
        self.filename_feedback_label = Label(self.history_frame, text="Filename error goes here", fg="#9C0000",
